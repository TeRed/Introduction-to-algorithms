...
def main():
    ...
    #Tablica wypełniana jest liczba z dużego zakresu
    #Na takich danych były przeprowadzane testy
    for i in range (0,N):
        List_of_random_numbers.append(random.randint(0,100))
    
    print('\n')
    print("List of random numbers to sort: ", List_of_random_numbers, end='\n\n')
    
    List_to_sort = list(List_of_random_numbers)
    
    selection_sort(List_to_sort, N)
    print("Selection Sort: ", List_to_sort)
    
    List_to_sort = list(List_of_random_numbers)
    
    insertion_sort(List_to_sort, N)
    print("Insertion Sort: ", List_to_sort)
    
    List_to_sort = list(List_of_random_numbers)
    
    bubble_sort(List_to_sort, N)
    print("Bubble Sort:    ", List_to_sort)
    
    List_to_sort = list(List_of_random_numbers)
    
    heap_sort(List_to_sort, N)
    print("Heap Sort:      ", List_to_sort)

    List_to_sort = list(List_of_random_numbers)
    
    quick_sort(List_to_sort, 0, N-1)
    print("Quick Sort:     ", List_to_sort)
